...
document.addEventListener("DOMContentLoaded", () => {
  ...
  window.addEventListener("load", async (e) => {
    e.preventDefault();
    await fetch(
      "http://localhost:8080/agendamentos/cliente/" +
      ...
      .then(async (res) => {
        ...
        if (agendamentos.mensagem.length == 0) {
          ...
          agendamentos.mensagem.forEach((res) => {
            ...
            const sobrenome = res.servico.usuario.sobrenome
            const data = res.data
            ...
            <div class=" bordaa1" id="deletar" style="border: 2px solid black;">
                ...
                <button onclick="editar(${idAgendamento}) "><img src="img/edit.png" alt="" width="15px" height="15px"></a></button> 
                <button onclick="apagar(${idAgendamento})" id="exclui"><img src="img/delete.png" alt=""></button></div>
                <p><strong>Prestador: ${nomePrestador + " " + sobrenome}</strong> </p>
...
function editar (id){
  ...
  window.location.href = "EditarAgendamentos.html"
}
